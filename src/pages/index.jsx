      ...
      <div className="bg-cover bg-center h-screen flex justify-center items-center">
        <div className="bg-primary/70 w-full sm:w-1/2 h-1/3 grid fadeIn1 place-content-center">
          ...
          <div className="flex justify-between mt-6">
            <a href="https://www.instagram.com/zamzam.goettingen/?hl=de">
            ...
            <Link to="/speisekarte" type="button" className="bg-tertiary active:bg-whatever hover:bg-secondary font-bold px-4 h-fit py-2 rounded flex">Zur Speisekarte</Link>
            <a href="https://www.facebook.com/people/Zamzam-G%C3%B6ttingen/100043319306665/">

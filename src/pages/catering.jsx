    ...
    <Layout>
      <div className="w-screen">
        ...
        <div className="bg-primary md:w-8/12 md:mx-auto mt-14 pb-10 mx-3">
          ...
          <StaticImage className="ml-3 md:float-right" src="../images/Falafel1.jpg" alt="Falafel" placeholder="blurred" quality={50} width={300} height={300} />
          <p className="m-3">
          ...
          <StaticImage className="md:float-left mt-16 mx-3" src="../images/Kibbah.jpg" alt="Buffet" placeholder="blurred" quality={50} width={250} height={250} />
